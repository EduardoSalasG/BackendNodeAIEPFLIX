...
generosRoute.get('/', [auth_1.Authentication, adminAuth_1.adminAuthentication], (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    let perPage = 5;
...
generosRoute.get('/search', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    var generos = yield genero_model_1.Genero.find({ 'nombre': { '$regex': searchText, '$options': 'i' } }).exec();
    res.json({
        ok: true,
        generos
    });
